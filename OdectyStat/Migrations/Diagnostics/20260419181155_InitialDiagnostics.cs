        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sensor_errors = table.Column<int>(type: "integer", nullable: false),
                    reset_reason = table.Column<byte>(type: "smallint", nullable: false),
                    loop_max_ms = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_heater_diagnostics", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "ix_heater_diagnostics_timestamp",
