...
{
    /// <inheritdoc />
    public partial class AddLSSensorDiagnostics : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ls_sensor_diagnostics",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ls_sensor_diagnostics", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "ix_ls_sensor_diagnostics_timestamp",
